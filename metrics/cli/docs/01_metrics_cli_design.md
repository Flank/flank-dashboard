...
To view the recommended versions of the dependencies, please check out the [dependencies file](https://github.com/platform-platform/monorepo/master/metrics/cli/recommended_versions.yaml).
