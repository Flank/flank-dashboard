...
void main() {
  group("Deployer", () {
    ...
    test(
      ".deploy() suggests to delete the GCloud project if GCloud service throws during the Firebase adding",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(
          gcloudService.addFirebase(any),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if GCloud service throws during the organization configuration",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(
          gcloudService.configureProjectOrganization(any),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Firebase service throws during the Firebase web app creation",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(
          firebaseService.createWebApp(any),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Git service throws during the checkout process",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(gitService.checkout(any, any)).thenAnswer(
          (_) => Future.error(stateError),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Npm service throws during the dependencies installing",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(npmService.installDependencies(any)).thenAnswer(
          (_) => Future.error(stateError),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Flutter service throws during the web application building",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(flutterService.build(any)).thenAnswer(
          (_) => Future.error(stateError),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Firebase service throws during the Firebase billing plan upgrading",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.upgradeBillingPlan(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() deletes the GCloud project if Firebase service throws during the Firebase billing plan upgrading and the user agrees to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.upgradeBillingPlan(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(true);
    ...
    test(
      ".deploy() does not delete the GCloud project if Firebase service throws during the Firebase billing plan upgrading and the user does not agree to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.upgradeBillingPlan(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() suggests to delete the GCloud project if the Firebase service throws during the Firebase Analytics enabling",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.enableAnalytics(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() deletes the GCloud project if the Firebase service throws during the Firebase Analytics enabling and the user agrees to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.enableAnalytics(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(true);
    ...
    test(
      ".deploy() does not delete the GCloud project if the Firebase service throws during the Firebase Analytics enabling and the user does not agree to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.enableAnalytics(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() suggests to delete the GCloud project if the Firebase service throws during initializing the Firestore data",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(
          firebaseService.initializeFirestoreData(any),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if the Firebase service throws during the Firebase auth providers configuration",
      () async {
        whenDirectoryExist().thenReturn(true);
        when(firebaseService.configureAuthProviders(any)).thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() suggests to delete the GCloud project if prompter throws during the Sentry config prompting",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() deletes the GCloud project if prompter throws during the Sentry config prompting and the user agrees to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(true);
    ...
    test(
      ".deploy() does not delete the GCloud project if prompter throws during the Sentry config prompting and the user does not agree to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenThrow(stateError);
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Sentry service throws during the login process",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenReturn(true);
        when(sentryService.login()).thenAnswer((_) => Future.error(stateError));
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Sentry service throws during the release creation",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenCreateSentryRelease().thenAnswer((_) => Future.error(stateError));
        whenPromptToDeleteProject().thenReturn(false);
    ...
    test(
      ".deploy() suggests to delete the GCloud project if prompter throws during the Sentry DSN requesting",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenCreateSentryRelease().thenAnswer(
          (_) => Future.value(sentryRelease),
    ...
    test(
      ".deploy() deletes the GCloud project if prompter throws during the Sentry DSN requesting and the user agrees to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenCreateSentryRelease().thenAnswer(
          (_) => Future.value(sentryRelease),
    ...
    test(
      ".deploy() does not delete the GCloud project if prompter throws during the Sentry DSN requesting and the user does not agree to delete the project",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenCreateSentryRelease().thenAnswer(
          (_) => Future.value(sentryRelease),
    ...
    test(
      ".deploy() suggests to delete the GCloud project if FileHelper throws during the Metrics config file getting",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenReturn(false);
        when(fileHelper.getFile(any)).thenThrow(stateError);
    ...
    test(
      ".deploy() suggests to delete the GCloud project if FileHelper throws during replacing variables in the Metrics config file",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenReturn(false);
        when(
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Firebase service throws during the Firebase components deployment",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenReturn(false);
        when(firebaseService.deployFirebase(any, any)).thenAnswer(
    ...
    test(
      ".deploy() suggests to delete the GCloud project if Firebase service throws during the Firebase hosting deployment",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenReturn(false);
        when(firebaseService.deployHosting(any, any, any)).thenAnswer(
    ...
    test(
      ".deploy() suggests to delete the GCloud project if GCloud service throws during the OAuth origins configuration",
      () async {
        whenDirectoryExist().thenReturn(true);
        whenPromptToSetupSentry().thenReturn(false);
        when(gcloudService.configureOAuthOrigins(any)).thenThrow(stateError);
