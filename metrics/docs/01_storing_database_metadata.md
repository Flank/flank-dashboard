...
See [Metrics Web Supported Database Version](https://github.com/platform-platform/monorepo/blob/web_app_version/metrics/web/docs/features/database_metadata/01_database_metadata.md) document to get more implementation details.
