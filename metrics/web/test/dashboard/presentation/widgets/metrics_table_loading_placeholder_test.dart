...
void main() {
  group("MetricsTableLoadingPlaceholder", () {
    ...
    testWidgets(
      ...
      (tester) async {
        await tester.pumpWidget(
          const _MetricsTableLoadingPlaceholderrTestbed(themeData: themeData),
        );
    ...
    testWidgets(
      "displays a limited number of shimmer containers that can fit on the screen",
      (tester) async {
        const height = 300.0;
        ...
        await tester.pumpWidget(
          const _MetricsTableLoadingPlaceholderrTestbed(),
        );

        final actualItemCount = tester.widgetList<ShimmerContainer>(
...
class _MetricsTableLoadingPlaceholderrTestbed extends StatelessWidget {
  /// A [MetricsThemeData] used in tests.
  final MetricsThemeData themeData;

  /// Creates an instance of the [_MetricsTableLoadingPlaceholderrTestbed].
  ///
