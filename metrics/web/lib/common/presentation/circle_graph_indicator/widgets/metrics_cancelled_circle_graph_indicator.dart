...
/// the [MetricsCircleGraphIndicatorAttentionLevel.cancelled] circle graph style
/// from the [MetricsCircleGraphIndicatorThemeData].
class MetricsCancelledCircleGraphIndicator extends MetricsCircleGraphIndicator {
  /// Creates a new instance of the [MetricsCancelledCircleGraphIndicator].
  const MetricsCancelledCircleGraphIndicator({Key key}) : super(key: key);
