...
The main purpose of this tool is to convert the given supported coverage report to the [CI integrations format](https://github.com/platform-platform/monorepo/blob/coverage_converter_design_improvement/metrics/ci_integrations/docs/01_ci_integration_module_architecture.md#coverage-report-format). To do so, we should create the following interfaces and abstract classes:
...
![Interfaces diagram](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://raw.githubusercontent.com/platform-platform/monorepo/coverage_converter_design_improvement/metrics/coverage_converter/docs/diagrams/coverage_interfaces_diagram.puml)
...
![Coverage conversion diagram](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://github.com/platform-platform/monorepo/raw/coverage_converter_design_improvement/metrics/coverage_converter/docs/diagrams/coverage_conversion_activity.puml)
...
![Coverage class diagram](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://github.com/platform-platform/monorepo/raw/coverage_converter_design_improvement/metrics/coverage_converter/docs/diagrams/coverage_class_diagram.puml)
...
![Coverage sequence diagram](http://www.plantuml.com/plantuml/proxy?cache=no&fmt=svg&src=https://github.com/platform-platform/monorepo/raw/coverage_converter_design_improvement/metrics/coverage_converter/docs/diagrams/coverage_sequence_diagram.puml)
