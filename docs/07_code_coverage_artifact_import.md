...
* The approach is sensitive to breaks/changes of CI artifacts storage and API server - if one changes the importing flow may require changes as well. 
...
4. Submit creating a new token by pressing the **Create New API Access Token** button at the bottom of the page.
5. Confirm your password and take a copy of the token created, as it won't be visible again.
