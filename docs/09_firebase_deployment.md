...
4. Go to the `web/index.html` file in the application directory.
5. You have two options for how to set up the configuration:
...
```
// Firebase project configuration, copied one in step 3
